...
setGlobals 2
set -x
/home/thanhpp/go/src/github.com/thanhpp/fabric-gm/build/bin/peer channel update -f org3_update_in_envelope.pb -c ${CHANNEL_NAME} -o orderer.example.com:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile "$ORDERER_CA"
{ set +x; } 2>/dev/null
