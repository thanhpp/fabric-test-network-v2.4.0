...
packageChaincode() {
  set -x
  /home/thanhpp/go/src/github.com/thanhpp/fabric-gm/build/bin/peer lifecycle chaincode package ${CC_NAME}.tar.gz --path ${CC_SRC_PATH} --lang ${CC_RUNTIME_LANGUAGE} --label ${CC_NAME}_${CC_VERSION} >&log.txt
  res=$?
